...
System.register(['aurelia-framework'], function (_export, _context) {
  ...
  var bindable, inject, customAttribute, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, Prefixed;
  ...
  return {
    ...
    execute: function () {
      _export('Prefixed', Prefixed = (_dec = inject(Element), _dec2 = customAttribute('prefixed'), _dec(_class = _dec2(_class = (_class2 = function () {
