System.register(['aurelia-framework', 'aurelia-view-manager'], function (_export) {
  'use strict';

  var bindable, bindingMode, customElement, resolvedView, SchemaForm;
  ...
  return {
    ...
    execute: function () {
      SchemaForm = (function () {
        ...
        SchemaForm = resolvedView('spoonx/form', 'schema-form')(SchemaForm) || SchemaForm;
        SchemaForm = customElement('schema-form')(SchemaForm) || SchemaForm;
        return SchemaForm;
      })();

      _export('SchemaForm', SchemaForm);
    }
  };
});