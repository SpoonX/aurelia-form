...
System.register(['aurelia-framework', 'aurelia-view-manager'], function (_export, _context) {
  ...
  var bindable, customElement, bindingMode, resolvedView, _dec, _dec2, _dec3, _dec4, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, FormInput;
  ...
  return {
    ...
    execute: function () {
      _export('FormInput', FormInput = (_dec = resolvedView('spoonx/form', 'form-input'), _dec2 = customElement('form-input'), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec4 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = function FormInput() {
        ...
        enumerable: true,
        initializer: null
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, 'type', [bindable], {
        enumerable: true,
        initializer: function initializer() {
          return 'text';
        }
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, 'name', [bindable], {
        enumerable: true,
        initializer: function initializer() {
          return '';
        }
