...
System.register(['aurelia-framework', 'aurelia-view-manager'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export('FormHelp', FormHelp = (_dec = resolvedView('spoonx/form', 'form-help'), _dec2 = customElement('form-help'), _dec(_class = _dec2(_class = (_class2 = function FormHelp() {
