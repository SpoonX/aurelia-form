...
System.register(['aurelia-framework', 'aurelia-view-manager'], function (_export, _context) {
  ...
  var bindable, customElement, resolvedView, _dec, _dec2, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, FormButton;
  ...
  return {
    ...
    execute: function () {
      _export('FormButton', FormButton = (_dec = resolvedView('spoonx/form', 'form-button'), _dec2 = customElement('form-button'), _dec(_class = _dec2(_class = (_class2 = function FormButton() {
