...
System.register(['aurelia-framework', 'aurelia-view-manager'], function (_export, _context) {
  ...
  var bindable, customElement, bindingMode, resolvedView, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, FormAssociation;
  ...
  return {
    ...
    execute: function () {
      _export('FormAssociation', FormAssociation = (_dec = resolvedView('spoonx/form', 'form-association'), _dec2 = customElement('form-association'), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = function FormAssociation() {
      ...
      _export('FormAssociation', FormAssociation);
    }
  };
});