...
export let FormRadio = (_dec = resolvedView('spoonx/form', 'form-radio'), _dec2 = customElement('form-radio'), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec4 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = class FormRadio {
  constructor() {
