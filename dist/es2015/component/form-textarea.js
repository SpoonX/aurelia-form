...
export let FormTextarea = (_dec = resolvedView('spoonx/form', 'form-textarea'), _dec2 = customElement('form-textarea'), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = class FormTextarea {
  constructor() {
