...
export let FormInput = (_dec = resolvedView('spoonx/form', 'form-input'), _dec2 = customElement('form-input'), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec4 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = class FormInput {
  constructor() {
