define(['exports', './../form-group'], function (exports, _formGroup) {
  ...
  var FormGroupCustomElement = (function (_FormGroup) {
    _inherits(FormGroupCustomElement, _FormGroup);

    function FormGroupCustomElement() {
      _classCallCheck(this, FormGroupCustomElement);

      _get(Object.getPrototypeOf(FormGroupCustomElement.prototype), 'constructor', this).apply(this, arguments);
    }

    return FormGroupCustomElement;
  })(_formGroup.FormGroup);

  exports.FormGroupCustomElement = FormGroupCustomElement;
});