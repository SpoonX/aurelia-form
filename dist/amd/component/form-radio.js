define(['exports', 'aurelia-framework', 'aurelia-view-manager'], function (exports, _aureliaFramework, _aureliaViewManager) {
  ...
  var FormRadio = exports.FormRadio = (_dec = (0, _aureliaViewManager.resolvedView)('spoonx/form', 'form-radio'), _dec2 = (0, _aureliaFramework.customElement)('form-radio'), _dec3 = (0, _aureliaFramework.bindable)({ defaultBindingMode: _aureliaFramework.bindingMode.twoWay }), _dec4 = (0, _aureliaFramework.bindable)({ defaultBindingMode: _aureliaFramework.bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = function FormRadio() {
