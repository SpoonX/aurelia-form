define(['exports', 'aurelia-framework', 'aurelia-view-manager'], function (exports, _aureliaFramework, _aureliaViewManager) {
  ...
  var FormError = exports.FormError = (_dec = (0, _aureliaViewManager.resolvedView)('spoonx/form', 'form-error'), _dec2 = (0, _aureliaFramework.customElement)('form-error'), _dec(_class = _dec2(_class = (_class2 = function FormError() {
