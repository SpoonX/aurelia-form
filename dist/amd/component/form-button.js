define(['exports', 'aurelia-framework', 'aurelia-view-manager'], function (exports, _aureliaFramework, _aureliaViewManager) {
  ...
  var FormButton = exports.FormButton = (_dec = (0, _aureliaViewManager.resolvedView)('spoonx/form', 'form-button'), _dec2 = (0, _aureliaFramework.customElement)('form-button'), _dec(_class = _dec2(_class = (_class2 = function FormButton() {
