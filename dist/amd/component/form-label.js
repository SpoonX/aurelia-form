define(['exports', 'aurelia-framework', 'aurelia-view-manager'], function (exports, _aureliaFramework, _aureliaViewManager) {
  ...
  var FormLabel = exports.FormLabel = (_dec = (0, _aureliaViewManager.resolvedView)('spoonx/form', 'form-label'), _dec2 = (0, _aureliaFramework.customElement)('form-label'), _dec(_class = _dec2(_class = (_class2 = function FormLabel() {
  ...
  }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, 'visible', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: function initializer() {
      return true;
    }
