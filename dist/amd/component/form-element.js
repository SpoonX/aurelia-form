define(['exports', 'aurelia-config', 'aurelia-framework', 'aurelia-view-manager', '../aurelia-form', 'aurelia-pal'], function (exports, _aureliaConfig, _aureliaFramework, _aureliaViewManager, _aureliaForm, _aureliaPal) {
  'use strict';
